 ...
 */function ut(t){return pt({...t,state:!0,attribute:!1})}class mt extends at{shouldUpdate(t){if(!t.has("hass")||1!==t.size)return!0;const e=t.get("hass");if(!e||!this.hass)return!0;const i=this.hassUpdateKey(e),s=this.hassUpdateKey(this.hass);return!i||!s||i.length!==s.length||i.some((t,e)=>!Object.is(t,s[e]))}}t([pt({attribute:!1})],mt.prototype,"hass",void 0);const gt="chores-manager-daily-card",_t="chores-manager-overview-card",ft="chores-manager-correction-card",yt="chores-manager-history-card",wt=new Set(["unknown","unavailable"]),bt=new WeakMap;function vt(t,e){return t.attributes[e]}function $t(t,e){const i=Number(vt(t,e));return Number.isFinite(i)?i:0}function kt(t){const e=bt.get(t.states);if(e)return e;const i=new Map,s=new Map,o=new Map,n=new Map,r=[],a=new Map;for(const[e,c]of Object.entries(t.states)){e.startsWith("person.")&&r.push({entityId:e,name:vt(c,"friendly_name")??e.slice(7).replaceAll("_"," ")});const t=vt(c,"child_id");if(!t)continue;const h=o.get(t)??[];h.push(c),o.set(t,h);const l=vt(c,"kid_name")??vt(c,"child_name");l?.trim()?n.set(t,l):n.has(t)||n.set(t,t);const d=vt(c,"person_entity_id");if(!s.has(t)&&"string"==typeof d&&d.startsWith("person.")&&s.set(t,d),e.startsWith("sensor.")&&!a.has(t)&&a.set(t,c),e.startsWith("switch.")&&!wt.has(c.state)&&"string"==typeof vt(c,"assignment_id")){const s=i.get(t)??[];s.push({assignmentId:vt(c,"assignment_id")??e,entityId:e,childId:t,title:vt(c,"title")??vt(c,"friendly_name")??e,category:vt(c,"category")??"Other",points:$t(c,"points"),icon:vt(c,"icon")??"mdi:checkbox-marked-circle-outline",sortOrder:$t(c,"sort_order"),completed:"on"===c.state}),i.set(t,s)}}for(const t of i.values())t.sort((t,e)=>t.category.localeCompare(e.category)||t.sortOrder-e.sortOrder||t.title.localeCompare(e.title));r.sort((t,e)=>t.name.localeCompare(e.name));const c={assignmentsByChild:i,associatedPersonByChild:s,childEntities:o,childNames:n,children:[...n.entries()].map(([t,e])=>({id:t,name:e})).sort((t,e)=>t.name.localeCompare(e.name)),personOptions:r,weeklyPointsByChild:a};return bt.set(t.states,c),c}function xt(t,e,i){return(i?t.states[i]:void 0)??kt(t).weeklyPointsByChild.get(e)}function Ct(t){return kt(t).children}function At(t,e){const i=e.child_entity?t.states[e.child_entity]:void 0;return e.child_id??(i?vt(i,"child_id"):void 0)}function Pt(t,e){return kt(t).childNames.get(e)}function St(t,e,i,s,o){return[i,s,Pt(t,e)].find(t=>t?.trim())?.trim()??o}function Et(t,e){return kt(t).assignmentsByChild.get(e)??[]}function jt(t,e,i){const s=xt(t,e,i);if(!s||wt.has(s.state))return;const o=Number(s.state);return Number.isFinite(o)?o:void 0}function Mt(t,e,i){const s=xt(t,e,i),o=s?vt(s,"week_start"):void 0;return"string"==typeof o?o:void 0}function zt(t,e){const i=e?t.states[e]:void 0;return i?vt(i,"entity_picture"):void 0}function Dt(t,e){return kt(t).associatedPersonByChild.get(e)}function Ut(t,e,i=[]){const s=kt(t),o=new Set(s.childEntities.get(e)??[]),n=s.associatedPersonByChild.get(e);for(const e of[...i,n]){const i=e?t.states[e]:void 0;i&&o.add(i)}return[...o]}function Tt(t,e,i=[]){return[t.connection,t.language,t.locale?.language,t.locale?.number_format,t.locale?.time_format,t.locale?.date_format,t.locale?.first_weekday,t.locale?.time_zone,t.user?.id,t.user?.is_admin,...Ut(t,e,i)]}const Ht={en:{chores:"Chores",completed:"Goal reached",no_chores:"No available chores.",points:"points",remaining:"remaining for",rewards:"Points & rewards",how_points_work:"How points work",reward_levels:"Rewards",daily:"Chores",history:"History",correction:"Correction",previous_week:"Previous week",adjust_points:"Adjust points",adjustment_amount:"Amount",adjustment_reason:"Reason (optional)",add_points:"Add points",subtract_points:"Subtract points",adjustment_error:"The point adjustment could not be saved.",weekly_points_error:"Weekly totals could not be loaded.",correction_error:"Correction data could not be loaded.",correction_child_not_found:"This child no longer exists. Select an available child in the card editor.",previous_date:"Previous date",next_date:"Next date",choose_date:"Choose date",close:"Close",back:"Back",correct_chores:"Correct chores",adjust:"Adjust",show:"View",add_completion:"Add completion",remove_completion:"Remove completion",weekly_chores:"Weekly chores",history_error:"Chore history could not be loaded.",history_empty:"No chores logged this week.",total:"Total"},sv:{chores:"Sysslor",completed:"Målet är uppnått",no_chores:"Inga tillgängliga sysslor.",points:"poäng",remaining:"kvar till",rewards:"Poäng & belöningar",how_points_work:"Så fungerar poängen",reward_levels:"Belöningar",daily:"Sysslor",history:"Historik",correction:"Korrigering",previous_week:"Förra veckan",adjust_points:"Justera poäng",adjustment_amount:"Antal",adjustment_reason:"Orsak (valfri)",add_points:"Lägg till poäng",subtract_points:"Dra av poäng",adjustment_error:"Poängjusteringen kunde inte sparas.",weekly_points_error:"Veckopoängen kunde inte hämtas.",correction_error:"Korrigeringsdata kunde inte hämtas.",correction_child_not_found:"Barnet finns inte längre. Välj ett tillgängligt barn i kortets redigerare.",previous_date:"Föregående datum",next_date:"Nästa datum",choose_date:"Välj datum",close:"Stäng",back:"Tillbaka",correct_chores:"Korrigera sysslor",adjust:"Justera",show:"Visa",add_completion:"Lägg till genomförd syssla",remove_completion:"Ta bort genomförd syssla",weekly_chores:"Veckans sysslor",history_error:"Historiken kunde inte hämtas.",history_empty:"Inga sysslor registrerade den här veckan.",total:"Totalt"}};function It(t,e){return"en"===t||"sv"===t?t:e?.language?.toLowerCase().startsWith("sv")?"sv":"en"}function Ot(t,e,i){return Ht[It(e,i)][t]}let Rt=class extends mt{constructor(){super(...arguments),this.pendingCompletions=new Map}static getConfigElement(){return document.createElement("chores-manager-daily-card-editor")}static getStubConfig(){return{child_id:"kid_1",locale:"auto"}}setConfig(t){if(!t?.child_id?.trim()&&!t?.child_entity?.trim())throw new Error("child_id or child_entity is required");this.config={locale:"auto",show_border:!0,show_header:!0,show_person:!0,show_points:!0,...t},this.requestUpdate()}getCardSize(){return 4}hassUpdateKey(t){if(!this.config)return;const e=At(t,this.config);return e?Tt(t,e,[this.config.child_entity,this.config.weekly_points_entity,this.config.person_entity]):void 0}render(){if(!this.hass||!this.config)return L;const t=At(this.hass,this.config);if(!t)return L;const e=Et(this.hass,t),i=function(t){return t.reduce((t,e)=>{const i=t.get(e.category)??[];return i.push(e),t.set(e.category,i),t},new Map)}(e.map(t=>({...t,completed:this.pendingCompletions.get(t.entityId)??t.completed}))),s=jt(this.hass,t,this.config.weekly_points_entity??this.config.child_entity),o=void 0===s?void 0:s+e.reduce((t,e)=>{const i=this.pendingCompletions.get(e.entityId)??e.completed;return i===e.completed?t:t+(i?e.points:-e.points)},0),n=zt(this.hass,this.config.person_entity??Dt(this.hass,t)),r=St(this.hass,t,this.config.name,void 0,Ot("chores",this.config.locale,this.hass));return W`
  ...
  `}};t([ut()],Nt.prototype,"inventory",void 0),t([ut()],Nt.prototype,"history",void 0),t([ut()],Nt.prototype,"weeklyPoints",void 0),t([ut()],Nt.prototype,"selectedDate",void 0),t([ut()],Nt.prototype,"pendingAssignment",void 0),t([ut()],Nt.prototype,"error",void 0),t([ut()],Nt.prototype,"dateInputReady",void 0),Nt=t([ht(ft)],Nt);const Wt={entity:{filter:[{domain:"sensor",integration:"chores_manager"}]}},Vt={ui_action:{actions:["more-info","navigate","url","toggle","perform-action","call-service","assist","none"],default_action:"none"}},Lt=[{label:"Chores",icon:"mdi:format-list-checks",color:"#00bcd4"},{label:"History",icon:"mdi:trophy-outline",color:"#ffc107"},{label:"Correction",icon:"mdi:wrench-cog",color:"#9c27b0"}];function Ft(t){const{visibility:e,...i}=t;return{...i,visibility_mode:e?.mode??"all",visibility_users:e?.users??[]}}function Kt(t){const e=[t.daily_action,t.history_action,t.correction_action];return Lt.flatMap((t,i)=>{const s=e[i];return s&&"none"!==s.action?[{...t,tap_action:s}]:[]})}function Gt(t,e){if("correction"===e)return{locale:"auto",show_border:!0,show_header:!0,...t};if("history"===e)return{locale:"auto",show_border:!0,show_header:!0,show_person:!0,show_points:!0,...t};const i={locale:"auto",show_header:!0,show_name:!0,show_person:!0,show_points:!0,show_border:!0,person_position:"center",person_size:"medium"};if("overview"===e){const e=t;return{...i,show_previous_week:!0,show_adjustments:!0,...t,...void 0===e.buttons?{buttons:Kt(e).length?Kt(e):Lt}:{}}}return{...i,...t}}class Jt extends at{constructor(){super(...arguments),this.users=[],this.addButton=()=>{const t=this.config,e=[...t.buttons??[]],i=Lt[e.length];i&&(this.config={...t,buttons:[...e,i]},this.emitConfigChanged())},this.computeLabel=t=>this.label(t.name)}setConfig(t){this.config=Gt(t,this.kind)}willUpdate(t){"overview"===this.kind&&t.has("hass")&&this.loadUsers()}loadUsers(){const t=this.hass?.connection;t&&t!==this.usersConnection&&(this.usersConnection=t,t.sendMessagePromise({type:"config/auth/list"}).then(t=>{this.users=t.filter(t=>t.is_active&&!t.system_generated).sort((t,e)=>t.name.localeCompare(e.name))}).catch(()=>{this.users=[]}))}render(){return this.config?W`
    ...
    `}buttonSchema(t){const e=[{name:"label",required:!0,selector:{text:{}}},{name:"icon",required:!0,selector:{icon:{}}},{name:"color",required:!0,selector:{text:{type:"color"}}},{name:"tap_action",selector:Vt},{name:"hold_action",selector:Vt},{name:"double_tap_action",selector:Vt},{name:"visibility_mode",selector:{select:{mode:"dropdown",options:[{label:"All users",value:"all"},{label:"Administrators",value:"administrators"},{label:"Allow selected users",value:"allow-list"},{label:"Hide from selected users",value:"deny-list"}]}}}],i=new Map(this.users.map(t=>[t.id,t.name]));for(const e of t.visibility_users??[])i.set(e,i.get(e)??e);return e.push({name:"visibility_users",selector:{select:{multiple:!0,mode:"dropdown",options:[...i].map(([t,e])=>({value:t,label:e}))}}}),e}onFormValueChanged(t){t.stopPropagation();const e=t.detail.value;if("correction"===this.kind)return this.config=Gt({...this.config,...e},this.kind),void this.emitConfigChanged();const i=e,s=this.config,o=i.child_id!==s.child_id;this.config=Gt({...this.config,...e,weekly_points_entity:o&&this.hass?this.matchingWeeklyPointsEntity(i.child_id):i.weekly_points_entity},this.kind),this.emitConfigChanged()}onButtonValueChanged(t,e){e.stopPropagation();const i=this.config,s=[...i.buttons??[]],o=Ft(s[t]);s[t]=function(t){const{visibility_mode:e,visibility_users:i,...s}=t;return{...s,visibility:{mode:e??"all",users:i??[]}}}({...o,...e.detail.value,visibility_users:e.detail.value.visibility_users??o.visibility_users}),this.config={...i,buttons:s},this.emitConfigChanged()}removeButton(t){const e=this.config,i=[...e.buttons??[]];i.splice(t,1),this.config={...e,buttons:i},this.emitConfigChanged()}emitConfigChanged(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0}))}matchingWeeklyPointsEntity(t){if(t&&this.hass)return Object.entries(this.hass.states).find(([e,i])=>e.startsWith("sensor.")&&i.attributes.child_id===t)?.[0]}label(t){return(this.hass?.language?.toLowerCase().startsWith("sv")?{add_button:"Lägg till knapp",button:"Knapp",buttons:"Knappar",child_id:"Barn",color:"Färg",description:"Beskrivning",double_tap_action:"Dubbeltryck",goal_points:"Reservmålpoäng",hold_action:"Håll inne",icon:"Ikon",label:"Etikett",locale:"Språk",name:"Visningsnamn",person_entity:"Personöverskrivning",person_position:"Bildposition",person_size:"Bildstorlek",points:"Poäng",progress_color:"Förloppsfärg",remove_button:"Ta bort knapp",rewards:"Belöningsnivåer",show_header:"Visa sidhuvud",show_name:"Visa namn",show_person:"Visa bild",show_border:"Visa kortkant",show_points:"daily"===this.kind||"history"===this.kind?"Visa poäng":"Visa poäng och belöningsmeddelande",show_previous_week:"Visa förra veckans poäng",show_adjustments:"Visa poängjustering",tap_action:"Tryck",visibility_mode:"Synlig för",visibility_users:"Användare",weekly_points_entity:"Veckopoäng"}:{add_button:"Add button",button:"Button",buttons:"Buttons",child_id:"Child",color:"Color",description:"Description",double_tap_action:"Double-tap behavior",goal_points:"Fallback goal points",hold_action:"Hold behavior",icon:"Icon",label:"Label",locale:"Language",name:"Display name",person_entity:"Person override",person_position:"Picture position",person_size:"Picture size",points:"Points",progress_color:"Progress color",remove_button:"Remove button",rewards:"Reward levels",show_header:"Show header",show_name:"Show name",show_person:"Show picture",show_border:"Show card border",show_points:"daily"===this.kind||"history"===this.kind?"Show points":"Show points and reward message",show_previous_week:"Show previous-week points",show_adjustments:"Show point adjustment",tap_action:"Tap behavior",visibility_mode:"Visible to",visibility_users:"Users",weekly_points_entity:"Weekly points"})[t]}static{this.styles=r`
    :host { display: block; }
  ...
  `}};var ee,ie;t([ut()],te.prototype,"history",void 0),t([ut()],te.prototype,"loadFailed",void 0),te=t([ht(yt)],te),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ee||(ee={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ie||(ie={}));const se=["closed","locked","off"],oe=(t,e,i,s)=>{s=s||{},i=null==i?{}:i;const o=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return o.detail=i,t.dispatchEvent(o),o},ne=t=>{oe(window,"haptic",t)},re=(t,e,i,s,o)=>{let n;if(o&&i.double_tap_action?n=i.double_tap_action:s&&i.hold_action?n=i.hold_action:!s&&i.tap_action&&(n=i.tap_action),n||(n={action:"more-info"}),!n.confirmation||n.confirmation.exemptions&&n.confirmation.exemptions.some(t=>t.user===e.user.id)||confirm(n.confirmation.text||`Are you sure you want to ${n.action}?`))switch(n.action){case"more-info":(n.entity||i.entity||i.camera_image)&&(oe(t,"hass-more-info",{entityId:n.entity?n.entity:i.entity?i.entity:i.camera_image}),n.haptic&&ne(n.haptic));break;case"navigate":n.navigation_path&&(((t,e,i=!1)=>{i?history.replaceState(null,"",e):history.pushState(null,"",e),oe(window,"location-changed",{replace:i})})(0,n.navigation_path),n.haptic&&ne(n.haptic));break;case"url":n.url_path&&window.open(n.url_path),n.haptic&&ne(n.haptic);break;case"toggle":i.entity&&(((t,e)=>{((t,e,i=!0)=>{const s=function(t){return t.substr(0,t.indexOf("."))}(e),o="group"===s?"homeassistant":s;let n;switch(s){case"lock":n=i?"unlock":"lock";break;case"cover":n=i?"open_cover":"close_cover";break;default:n=i?"turn_on":"turn_off"}t.callService(o,n,{entity_id:e})})(t,e,se.includes(t.states[e].state))})(e,i.entity),n.haptic&&ne(n.haptic));break;case"call-service":{if(!n.service)return;const[t,s]=n.service.split(".",2),o=Object.assign({},n.service_data);"entity"===o.entity_id&&(o.entity_id=i.entity),e.callService(t,s,o,n.target),n.haptic&&ne(n.haptic);break}case"fire-dom-event":oe(t,"ll-custom",n),n.haptic&&ne(n.haptic)}},ae={amber:"#ffc107",blue:"#2196f3",cyan:"#00bcd4",green:"#4caf50",orange:"#ff9800",purple:"#9c27b0",red:"#f44336",teal:"#009688",yellow:"#ffeb3b"},ce=/^#[0-9a-f]{6}$/iu,he=new WeakMap;const le=[{label:"Chores",icon:"mdi:format-list-checks",color:"#00bcd4"},{label:"History",icon:"mdi:trophy-outline",color:"#ffc107"},{label:"Correction",icon:"mdi:wrench-cog",color:"#9c27b0"}];let de=class extends mt{constructor(){super(...arguments),this.weeklyPointsError=!1,this.adjustmentPending=!1,this.adjustmentError=!1,this.revealAdjustment=!1,this.heldButtons=new WeakSet,this.holdTimers=new WeakMap,this.clickTimers=new WeakMap}static getConfigElement(){return document.createElement("chores-manager-overview-card-editor")}static getStubConfig(){return{child_id:"kid_1",goal_points:20,progress_color:"#00a6d6",person_position:"center",locale:"auto",rewards:[{points:20,label:"Weekly reward",color:"#34c759"},{points:30,label:"Weekly reward and allowance",color:"#ff9f0a"}]}}setConfig(t){if(!t?.child_id?.trim()&&!t?.child_entity?.trim())throw new Error("child_id or child_entity is required");if(void 0!==t.goal_points&&t.goal_points<=0)throw new Error("goal_points must be above zero");if(this.config={locale:"auto",person_position:"center",person_size:"medium",show_name:!0,show_person:!0,show_points:!0,show_previous_week:!0,show_adjustments:!0,show_border:!0,rewards:[],...t},this.hass){const t=At(this.hass,this.config);t&&this.loadWeeklyPoints(t)}this.requestUpdate()}willUpdate(t){if(!t.has("hass"))return;const e=this.hass&&this.config?At(this.hass,this.config):void 0;if(e){jt(this.hass,e,this.config?.weekly_points_entity??this.config?.child_entity)===this.confirmedPoints&&(this.confirmedPoints=void 0),this.loadWeeklyPoints(e)}}getCardSize(){return 5}hassUpdateKey(t){if(!this.config)return;const e=At(t,this.config);return e?Tt(t,e,[this.config.child_entity,this.config.weekly_points_entity,this.config.person_entity,this.weeklyPoints?.person_entity_id]):void 0}render(){if(!this.hass||!this.config)return L;const t=At(this.hass,this.config);if(!t)return L;const e=jt(this.hass,t,this.config.weekly_points_entity??this.config.child_entity)??0,i=this.confirmedPoints??e,s=Et(this.hass,t),o=[...this.config.rewards??[]].sort((t,e)=>t.points-e.points),n=this.nextReward(i,o),r=n?.points??o.at(-1)?.points??this.config.goal_points??20,a=zt(this.hass,this.config.person_entity??this.weeklyPoints?.person_entity_id??Dt(this.hass,t)),c=St(this.hass,t,this.config.name,this.weeklyPoints?.child_name,Ot("chores",this.config.locale,this.hass)),h=this.config.person_position??"left",l=this.config.person_size??"medium",d=Math.min(100,Math.round(i/r*100)),p=this.progressColor(i,o),u=this.buttons().filter(t=>this.isVisible(t));return W`
      <ha-card class=${!1===this.config.show_border?"borderless":""}>
    ...
    `}renderCompactAdjustment(t,e){const i=!1!==this.config?.show_adjustments;return this.weeklyPointsError?W`
