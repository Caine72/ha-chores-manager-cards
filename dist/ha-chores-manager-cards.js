 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x=globalThis,k=t=>t,C=x.trustedTypes,A=C?C.createPolicy("lit-html",{createHTML:t=>t}):void 0,P="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,S="?"+E,j=`<${S}>`,M=document,z=()=>M.createComment(""),D=t=>null===t||"object"!=typeof t&&"function"!=typeof t,T=Array.isArray,O="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,U=/-->/g,H=/>/g,I=RegExp(`>|${O}(?:([^\\s"'>=/]+)(${O}*=${O}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),N=/'/g,B=/"/g,V=/^(?:script|style|textarea|title)$/i,L=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),W=Symbol.for("lit-noChange"),q=Symbol.for("lit-nothing"),F=new WeakMap,K=M.createTreeWalker(M,129);function G(t,e){if(!T(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(e):e}const J=(t,e)=>{const i=t.length-1,s=[];let o,n=2===e?"<svg>":3===e?"<math>":"",r=R;for(let e=0;e<i;e++){const i=t[e];let a,c,l=-1,h=0;for(;h<i.length&&(r.lastIndex=h,c=r.exec(i),null!==c);)h=r.lastIndex,r===R?"!--"===c[1]?r=U:void 0!==c[1]?r=H:void 0!==c[2]?(V.test(c[2])&&(o=RegExp("</"+c[2],"g")),r=I):void 0!==c[3]&&(r=I):r===I?">"===c[0]?(r=o??R,l=-1):void 0===c[1]?l=-2:(l=r.lastIndex-c[2].length,a=c[1],r=void 0===c[3]?I:'"'===c[3]?B:N):r===B||r===N?r=I:r===U||r===H?r=R:(r=I,o=void 0);const d=r===I&&t[e+1].startsWith("/>")?" ":"";n+=r===R?i+j:l>=0?(s.push(a),i.slice(0,l)+P+i.slice(l)+E+d):i+E+(-2===l?e:d)}return[G(t,n+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class Z{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,n=0;const r=t.length-1,a=this.parts,[c,l]=J(t,e);if(this.el=Z.createElement(c,i),K.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=K.nextNode())&&a.length<r;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(P)){const e=l[n++],i=s.getAttribute(t).split(E),r=/([.?@])?(.*)/.exec(e);a.push({type:1,index:o,name:r[2],strings:i,ctor:"."===r[1]?et:"?"===r[1]?it:"@"===r[1]?st:tt}),s.removeAttribute(t)}else t.startsWith(E)&&(a.push({type:6,index:o}),s.removeAttribute(t));if(V.test(s.tagName)){const t=s.textContent.split(E),e=t.length-1;if(e>0){s.textContent=C?C.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],z()),K.nextNode(),a.push({type:2,index:++o});s.append(t[e],z())}}}else if(8===s.nodeType)if(s.data===S)a.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(E,t+1));)a.push({type:7,index:o}),t+=E.length-1}o++}}static createElement(t,e){const i=M.createElement("template");return i.innerHTML=t,i}}function Q(t,e,i=t,s){if(e===W)return e;let o=void 0!==s?i._$Co?.[s]:i._$Cl;const n=D(e)?void 0:e._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),void 0===n?o=void 0:(o=new n(t),o._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=o:i._$Cl=o),void 0!==o&&(e=Q(t,o._$AS(t,e.values),o,s)),e}class X{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??M).importNode(e,!0);K.currentNode=s;let o=K.nextNode(),n=0,r=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new Y(o,o.nextSibling,this,t):1===a.type?e=new a.ctor(o,a.name,a.strings,this,t):6===a.type&&(e=new ot(o,this,t)),this._$AV.push(e),a=i[++r]}n!==a?.index&&(o=K.nextNode(),n++)}return K.currentNode=M,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Y{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),D(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>T(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==q&&D(this._$AH)?this._$AA.nextSibling.data=t:this.T(M.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=Z.createElement(G(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new X(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=F.get(t.strings);return void 0===e&&F.set(t.strings,e=new Z(t)),e}k(t){T(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new Y(this.O(z()),this.O(z()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=k(t).nextSibling;k(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class tt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,o){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=q}_$AI(t,e=this,i,s){const o=this.strings;let n=!1;if(void 0===o)t=Q(this,t,e,0),n=!D(t)||t!==this._$AH&&t!==W,n&&(this._$AH=t);else{const s=t;let r,a;for(t=o[0],r=0;r<o.length-1;r++)a=Q(this,s[i+r],e,r),a===W&&(a=this._$AH[r]),n||=!D(a)||a!==this._$AH[r],a===q?t=q:t!==q&&(t+=(a??"")+o[r+1]),this._$AH[r]=a}n&&!s&&this.j(t)}j(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class et extends tt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===q?void 0:t}}class it extends tt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==q)}}class st extends tt{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??q)===W)return;const i=this._$AH,s=t===q&&i!==q||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==q&&(i===q||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ot{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const nt=x.litHtmlPolyfillSupport;nt?.(Z,Y),(x.litHtmlVersions??=[]).push("3.3.3");const rt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function ut(t){return pt({...t,state:!0,attribute:!1})}class mt extends at{}t([pt({attribute:!1})],mt.prototype,"hass",void 0);const gt="chores-manager-daily-card",_t="chores-manager-overview-card",ft="chores-manager-correction-card",yt=new Set(["unknown","unavailable"]);function bt(t,e){return t.attributes[e]}function wt(t,e){const i=Number(bt(t,e));return Number.isFinite(i)?i:0}function vt(t){const e=new Map;for(const i of Object.values(t.states)){const t=bt(i,"child_id");if(!t)continue;const s=bt(i,"kid_name")??bt(i,"child_name");s?.trim()?e.set(t,s):e.has(t)||e.set(t,t)}return[...e.entries()].map(([t,e])=>({id:t,name:e})).sort((t,e)=>t.name.localeCompare(e.name))}function $t(t,e){const i=e.child_entity?t.states[e.child_entity]:void 0;return e.child_id??(i?bt(i,"child_id"):void 0)}function xt(t,e){return vt(t).find(t=>t.id===e)?.name}function kt(t,e){return Object.entries(t.states).filter(([t,i])=>t.startsWith("switch.")&&!yt.has(i.state)&&bt(i,"child_id")===e&&"string"==typeof bt(i,"assignment_id")).map(([t,i])=>({assignmentId:bt(i,"assignment_id")??t,entityId:t,childId:e,title:bt(i,"title")??bt(i,"friendly_name")??t,category:bt(i,"category")??"Other",points:wt(i,"points"),icon:bt(i,"icon")??"mdi:checkbox-marked-circle-outline",sortOrder:wt(i,"sort_order"),completed:"on"===i.state})).sort((t,e)=>t.category.localeCompare(e.category)||t.sortOrder-e.sortOrder||t.title.localeCompare(e.title))}function Ct(t,e,i){const s=(i?t.states[i]:void 0)??Object.entries(t.states).find(([t,i])=>t.startsWith("sensor.")&&bt(i,"child_id")===e)?.[1];if(!s||yt.has(s.state))return;const o=Number(s.state);return Number.isFinite(o)?o:void 0}function At(t,e){const i=e?t.states[e]:void 0;return i?bt(i,"entity_picture"):void 0}const Pt={en:{chores:"Chores",completed:"Goal reached",no_chores:"No available chores.",points:"points",remaining:"remaining for",rewards:"Points & rewards",how_points_work:"How points work",reward_levels:"Rewards",daily:"Chores",history:"History",correction:"Correction",previous_week:"Previous week",adjust_points:"Adjust points",adjustment_amount:"Amount",adjustment_reason:"Reason (optional)",add_points:"Add points",subtract_points:"Subtract points",adjustment_error:"The point adjustment could not be saved.",weekly_points_error:"Weekly totals could not be loaded.",correction_error:"Correction data could not be loaded.",correction_child_not_found:"This child no longer exists. Select an available child in the card editor.",previous_date:"Previous date",next_date:"Next date",choose_date:"Choose date",close:"Close",back:"Back",correct_chores:"Correct chores",adjust:"Adjust",show:"View",add_completion:"Add completion",remove_completion:"Remove completion"},sv:{chores:"Sysslor",completed:"Målet är uppnått",no_chores:"Inga tillgängliga sysslor.",points:"poäng",remaining:"kvar till",rewards:"Poäng & belöningar",how_points_work:"Så fungerar poängen",reward_levels:"Belöningar",daily:"Sysslor",history:"Historik",correction:"Korrigering",previous_week:"Förra veckan",adjust_points:"Justera poäng",adjustment_amount:"Antal",adjustment_reason:"Orsak (valfri)",add_points:"Lägg till poäng",subtract_points:"Dra av poäng",adjustment_error:"Poängjusteringen kunde inte sparas.",weekly_points_error:"Veckopoängen kunde inte hämtas.",correction_error:"Korrigeringsdata kunde inte hämtas.",correction_child_not_found:"Barnet finns inte längre. Välj ett tillgängligt barn i kortets redigerare.",previous_date:"Föregående datum",next_date:"Nästa datum",choose_date:"Välj datum",close:"Stäng",back:"Tillbaka",correct_chores:"Korrigera sysslor",adjust:"Justera",show:"Visa",add_completion:"Lägg till genomförd syssla",remove_completion:"Ta bort genomförd syssla"}};function Et(t,e){return"en"===t||"sv"===t?t:e?.language?.toLowerCase().startsWith("sv")?"sv":"en"}function St(t,e,i){return Pt[Et(e,i)][t]}let jt=class extends mt{constructor(){super(...arguments),this.pendingCompletions=new Map}static getConfigElement(){return document.createElement("chores-manager-daily-card-editor")}static getStubConfig(){return{child_id:"kid_1",locale:"auto"}}setConfig(t){if(!t?.child_id?.trim()&&!t?.child_entity?.trim())throw new Error("child_id or child_entity is required");this.config={locale:"auto",show_border:!0,show_header:!0,show_person:!0,show_points:!0,...t},this.requestUpdate()}getCardSize(){return 4}render(){if(!this.hass||!this.config)return q;const t=$t(this.hass,this.config);if(!t)return q;const e=kt(this.hass,t),i=function(t){return t.reduce((t,e)=>{const i=t.get(e.category)??[];return i.push(e),t.set(e.category,i),t},new Map)}(e.map(t=>({...t,completed:this.pendingCompletions.get(t.entityId)??t.completed}))),s=Ct(this.hass,t,this.config.weekly_points_entity??this.config.child_entity),o=void 0===s?void 0:s+e.reduce((t,e)=>{const i=this.pendingCompletions.get(e.entityId)??e.completed;return i===e.completed?t:t+(i?e.points:-e.points)},0),n=At(this.hass,this.config.person_entity),r=this.config.name??this.config.title??xt(this.hass,t)??St("chores",this.config.locale,this.hass);return L`
      ...
      <section>
        ...
        ${e.map(t=>L`
            ...
            >
              ...
              ${!1!==this.config?.show_points?L`<span class="points">${t.points}p</span>`:q}
              <ha-icon
                class="check"
  ...
  `}};t([ut()],jt.prototype,"error",void 0),t([ut()],jt.prototype,"pendingCompletions",void 0),jt=t([lt(gt)],jt);let Mt=class extends mt{constructor(){super(...arguments),this.dateInputReady=Boolean(customElements.get("ha-date-input")),this.goBack=()=>history.back(),this.close=()=>{location.hash?location.hash="":history.back()}}static getConfigElement(){return document.createElement("chores-manager-correction-card-editor")}static getStubConfig(t){return{child_id:t?vt(t)[0]?.id??"kid_1":"kid_1",locale:"auto",show_border:!0,show_header:!0}}connectedCallback(){super.connectedCallback(),this.loadDateInput()}setConfig(t){if(!t?.child_id?.trim())throw new Error("child_id is required");this.config={locale:"auto",show_border:!0,show_header:!0,...t},this.load(),this.requestUpdate()}willUpdate(){this.load()}getCardSize(){return 9}render(){if(!this.hass||!this.config)return q;const t=this.inventory?.children.find(t=>t.child_id===this.config?.child_id),e=this.config.name??t?.name??this.config.child_id,i=At(this.hass,this.config.person_entity);return L`
      <ha-card class=${!1===this.config.show_border?"borderless":""}>
        ${!1!==this.config.show_header?L`
              <header>
                ${i?L`<img class="portrait" src=${i} alt="" />`:L`<ha-icon class="portrait-icon" icon="mdi:account-circle"></ha-icon>`}
                <strong class="title">${St("correct_chores",this.config.locale,this.hass)} - ${e}</strong>
                <span class="header-points">${this.weeklyPoints?.current_week.points??0}p</span>
                <button class="header-button" aria-label=${St("back",this.config.locale,this.hass)} @click=${this.goBack}>
                  <ha-icon icon="mdi:arrow-left"></ha-icon>
                </button>
                <button class="header-button" aria-label=${St("close",this.config.locale,this.hass)} @click=${this.close}>
                  <ha-icon icon="mdi:close"></ha-icon>
                </button>
              </header>
            `:q}
        ${this.error?L`<p class="error" role="alert">${St("child_not_found"===this.error?"correction_child_not_found":"correction_error",this.config.locale,this.hass)}</p>`:this.history&&this.inventory&&this.selectedDate?L`
                ${this.renderDateNavigation()}
                <div class="groups">${this.renderGroups()}</div>
              `:q}
      </ha-card>
    `}renderDateNavigation(){const t=Et(this.config?.locale,this.hass),e=new Date(`${this.selectedDate}T12:00:00`),i=new Intl.DateTimeFormat("sv"===t?"sv-SE":"en-US",{weekday:"short",day:"numeric",month:"short"}).format(e),s=this.selectedDate===this.history?.window.start,o=this.selectedDate===this.history?.window.end;return L`
      <section class="date-navigation">
        <h1>${i}</h1>
        <div class="date-actions">
          <button ?disabled=${s} aria-label=${St("previous_date",this.config?.locale,this.hass)} @click=${()=>this.shiftDate(-1)}>
            <ha-icon icon="mdi:chevron-left"></ha-icon>
          </button>
          <button ?disabled=${o} aria-label=${St("next_date",this.config?.locale,this.hass)} @click=${()=>this.shiftDate(1)}>
          ...
          >
            ...
            <ha-date-input
              .label=${St("choose_date",this.config?.locale,this.hass)}
    ...
    `}renderGroups(){const t=new Map;for(const e of this.rows()){const i=t.get(e.chore.category)??[];i.push(e),t.set(e.chore.category,i)}return[...t].map(([t,e])=>L`
      ...
      `)}renderRow(t){const e=this.pendingAssignment===t.assignment.assignment_id,i=t.completed?St("remove_completion",this.config?.locale,this.hass):St("add_completion",this.config?.locale,this.hass);return L`
      <div class="chore-row">
  ...
  `}};t([ut()],Mt.prototype,"inventory",void 0),t([ut()],Mt.prototype,"history",void 0),t([ut()],Mt.prototype,"weeklyPoints",void 0),t([ut()],Mt.prototype,"selectedDate",void 0),t([ut()],Mt.prototype,"pendingAssignment",void 0),t([ut()],Mt.prototype,"error",void 0),t([ut()],Mt.prototype,"dateInputReady",void 0),Mt=t([lt(ft)],Mt);const zt={entity:{filter:[{domain:"sensor",integration:"chores_manager"}]}},Dt={ui_action:{actions:["more-info","navigate","url","toggle","perform-action","call-service","assist","none"],default_action:"none"}},Tt=[{label:"Chores",icon:"mdi:format-list-checks",color:"#00bcd4"},{label:"History",icon:"mdi:trophy-outline",color:"#ffc107"},{label:"Correction",icon:"mdi:wrench-cog",color:"#9c27b0"}];function Ot(t){const{visibility:e,...i}=t;return{...i,visibility_mode:e?.mode??"all",visibility_users:e?.users??[]}}function Rt(t){const e=[t.daily_action,t.history_action,t.correction_action];return Tt.flatMap((t,i)=>{const s=e[i];return s&&"none"!==s.action?[{...t,tap_action:s}]:[]})}function Ut(t,e){if("correction"===e)return{locale:"auto",show_border:!0,show_header:!0,...t};const i={locale:"auto",show_header:!0,show_name:!0,show_person:!0,show_points:!0,show_border:!0,person_position:"center",person_size:"medium"};if("overview"===e){const e=t;return{...i,show_previous_week:!0,show_adjustments:!0,...t,...void 0===e.buttons?{buttons:Rt(e).length?Rt(e):Tt}:{}}}return{...i,...t}}class Ht extends at{constructor(){super(...arguments),this.users=[],this.addButton=()=>{const t=this.config,e=[...t.buttons??[]],i=Tt[e.length];i&&(this.config={...t,buttons:[...e,i]},this.emitConfigChanged())},this.computeLabel=t=>this.label(t.name)}setConfig(t){this.config=Ut(t,this.kind)}willUpdate(t){"overview"===this.kind&&t.has("hass")&&this.loadUsers()}loadUsers(){const t=this.hass?.connection;t&&t!==this.usersConnection&&(this.usersConnection=t,t.sendMessagePromise({type:"config/auth/list"}).then(t=>{this.users=t.filter(t=>t.is_active&&!t.system_generated).sort((t,e)=>t.name.localeCompare(e.name))}).catch(()=>{this.users=[]}))}render(){return this.config?L`
      <ha-form
        .hass=${this.hass}
        .data=${this.formData()}
        .schema=${this.schema()}
  ...
  `}}t([pt({attribute:!1})],Ht.prototype,"hass",void 0),t([ut()],Ht.prototype,"config",void 0),t([ut()],Ht.prototype,"users",void 0);let It=class extends Ht{constructor(){super(...arguments),this.kind="daily"}};It=t([lt("chores-manager-daily-card-editor")],It);let Nt=class extends Ht{constructor(){super(...arguments),this.kind="overview"}};Nt=t([lt("chores-manager-overview-card-editor")],Nt);let Bt=class extends Ht{constructor(){super(...arguments),this.kind="correction"}};var Vt,Lt;Bt=t([lt("chores-manager-correction-card-editor")],Bt),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Vt||(Vt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Lt||(Lt={}));const Wt=["closed","locked","off"],qt=(t,e,i,s)=>{s=s||{},i=null==i?{}:i;const o=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return o.detail=i,t.dispatchEvent(o),o},Ft=t=>{qt(window,"haptic",t)},Kt=(t,e,i,s,o)=>{let n;if(o&&i.double_tap_action?n=i.double_tap_action:s&&i.hold_action?n=i.hold_action:!s&&i.tap_action&&(n=i.tap_action),n||(n={action:"more-info"}),!n.confirmation||n.confirmation.exemptions&&n.confirmation.exemptions.some(t=>t.user===e.user.id)||confirm(n.confirmation.text||`Are you sure you want to ${n.action}?`))switch(n.action){case"more-info":(n.entity||i.entity||i.camera_image)&&(qt(t,"hass-more-info",{entityId:n.entity?n.entity:i.entity?i.entity:i.camera_image}),n.haptic&&Ft(n.haptic));break;case"navigate":n.navigation_path&&(((t,e,i=!1)=>{i?history.replaceState(null,"",e):history.pushState(null,"",e),qt(window,"location-changed",{replace:i})})(0,n.navigation_path),n.haptic&&Ft(n.haptic));break;case"url":n.url_path&&window.open(n.url_path),n.haptic&&Ft(n.haptic);break;case"toggle":i.entity&&(((t,e)=>{((t,e,i=!0)=>{const s=function(t){return t.substr(0,t.indexOf("."))}(e),o="group"===s?"homeassistant":s;let n;switch(s){case"lock":n=i?"unlock":"lock";break;case"cover":n=i?"open_cover":"close_cover";break;default:n=i?"turn_on":"turn_off"}t.callService(o,n,{entity_id:e})})(t,e,Wt.includes(t.states[e].state))})(e,i.entity),n.haptic&&Ft(n.haptic));break;case"call-service":{if(!n.service)return;const[t,s]=n.service.split(".",2),o=Object.assign({},n.service_data);"entity"===o.entity_id&&(o.entity_id=i.entity),e.callService(t,s,o,n.target),n.haptic&&Ft(n.haptic);break}case"fire-dom-event":qt(t,"ll-custom",n),n.haptic&&Ft(n.haptic)}},Gt={amber:"#ffc107",blue:"#2196f3",cyan:"#00bcd4",green:"#4caf50",orange:"#ff9800",purple:"#9c27b0",red:"#f44336",teal:"#009688",yellow:"#ffeb3b"},Jt=/^#[0-9a-f]{6}$/iu,Zt=[{label:"Chores",icon:"mdi:format-list-checks",color:"#00bcd4"},{label:"History",icon:"mdi:trophy-outline",color:"#ffc107"},{label:"Correction",icon:"mdi:wrench-cog",color:"#9c27b0"}];let Qt=class extends mt{constructor(){super(...arguments),this.weeklyPointsError=!1,this.adjustmentPending=!1,this.adjustmentError=!1,this.heldButtons=new WeakSet,this.holdTimers=new WeakMap,this.clickTimers=new WeakMap}static getConfigElement(){return document.createElement("chores-manager-overview-card-editor")}static getStubConfig(){return{child_id:"kid_1",goal_points:20,progress_color:"#00a6d6",person_position:"center",locale:"auto",rewards:[{points:20,label:"Weekly reward",color:"#34c759"},{points:30,label:"Weekly reward and allowance",color:"#ff9f0a"}]}}setConfig(t){if(!t?.child_id?.trim()&&!t?.child_entity?.trim())throw new Error("child_id or child_entity is required");if(void 0!==t.goal_points&&t.goal_points<=0)throw new Error("goal_points must be above zero");if(this.config={locale:"auto",person_position:"center",person_size:"medium",show_name:!0,show_person:!0,show_points:!0,show_previous_week:!0,show_adjustments:!0,show_border:!0,rewards:[],...t},this.hass){const t=$t(this.hass,this.config);t&&this.loadWeeklyPoints(t)}this.requestUpdate()}willUpdate(t){if(!t.has("hass"))return;const e=this.hass&&this.config?$t(this.hass,this.config):void 0;if(e){Ct(this.hass,e,this.config?.weekly_points_entity??this.config?.child_entity)===this.confirmedPoints&&(this.confirmedPoints=void 0),this.loadWeeklyPoints(e)}}getCardSize(){return 5}render(){if(!this.hass||!this.config)return q;const t=$t(this.hass,this.config);if(!t)return q;const e=Ct(this.hass,t,this.config.weekly_points_entity??this.config.child_entity)??0,i=this.confirmedPoints??e,s=kt(this.hass,t),o=[...this.config.rewards??[]].sort((t,e)=>t.points-e.points),n=this.nextReward(i,o),r=n?.points??o.at(-1)?.points??this.config.goal_points??20,a=At(this.hass,this.config.person_entity),c=this.config.name??xt(this.hass,t)??t,l=this.config.person_position??"left",h=this.config.person_size??"medium",d=Math.min(100,Math.round(i/r*100)),p=this.progressColor(i,o),u=this.buttons().filter(t=>this.isVisible(t));return L`
      <ha-card class=${!1===this.config.show_border?"borderless":""}>
              ...
              <header>
                <div class="overview-heading">
                  ...
                  ${!1!==this.config.show_previous_week&&this.weeklyPoints?L`<span class="previous-week">
                        ${St("previous_week",this.config.locale,this.hass)} ·
        ...
        <div class="points-row" ?hidden=${!1===this.config.show_points}>
          ...
          <div>
            <strong>${i} / ${r} ${St("points",this.config.locale,this.hass)}</strong>
            ${n?L`<p>${this.rewardMessage(i,n)}</p>`:L`<p>${this.finalRewardMessage(o)}</p>`}
          </div>
        </div>
        ...
        ${u.length?L`
            ...
            `:q}
        ${s.length||o.length?this.renderPointsAndRewards(s,o):q}
      </ha-card>
    `}renderCompactAdjustment(t){const e=!1!==this.config?.show_adjustments;if(this.weeklyPointsError)return L`
        <p class="api-error" role="alert">
          ${St("weekly_points_error",this.config?.locale,this.hass)}
        </p>
      `;if(!e||!this.weeklyPoints||this.weeklyPoints.child_id!==t||!this.weeklyPoints.can_adjust)return q;const i=this.confirmedPoints??this.weeklyPoints.current_week.points;return L`
      <section class="compact-adjustment">
        <span class="adjustment-label">
          <ha-icon icon="mdi:tune-variant"></ha-icon>
          ${St("adjust",this.config?.locale,this.hass)}
        </span>
        <div class="adjustment-actions">
          <button
            class="subtract"
            ?disabled=${this.adjustmentPending||i<=0}
            aria-label=${St("subtract_points",this.config?.locale,this.hass)}
            @click=${()=>this.adjustPoints(t,-1)}
          ><ha-icon icon="mdi:minus"></ha-icon><span>1</span></button>
          <button
            class="add"
            ?disabled=${this.adjustmentPending}
            aria-label=${St("add_points",this.config?.locale,this.hass)}
            @click=${()=>this.adjustPoints(t,1)}
          ><ha-icon icon="mdi:plus"></ha-icon><span>1</span></button>
        </div>
        ${this.adjustmentError?L`<p class="api-error" role="alert">
              ${St("adjustment_error",this.config?.locale,this.hass)}
            </p>`:q}
      </section>
    `}loadWeeklyPoints(t){const e=this.hass?.connection;e&&(t===this.weeklyPointsChildId&&e===this.weeklyPointsConnection||(this.weeklyPointsChildId=t,this.weeklyPointsConnection=e,this.weeklyPoints=void 0,this.weeklyPointsError=!1,e.sendMessagePromise({type:"chores_manager/weekly_points",child_id:t}).then(i=>{this.weeklyPointsChildId===t&&this.weeklyPointsConnection===e&&(this.weeklyPoints=i)}).catch(()=>{this.weeklyPointsChildId===t&&this.weeklyPointsConnection===e&&(this.weeklyPointsError=!0)})))}async adjustPoints(t,e){const i=this.hass?.connection;if(i&&!this.adjustmentPending){this.adjustmentPending=!0,this.adjustmentError=!1;try{const s=await i.sendMessagePromise({type:"chores_manager/adjust_weekly_points",child_id:t,amount:e});this.confirmedPoints=s.current_points,this.weeklyPoints?.child_id===t&&(this.weeklyPoints={...this.weeklyPoints,current_week:{...this.weeklyPoints.current_week,points:s.current_points}})}catch{this.adjustmentError=!0}finally{this.adjustmentPending=!1}}}renderPointsAndRewards(t,e){const i=new Map;for(const e of t){const t=i.get(e.points)??[];t.push(e),i.set(e.points,t)}return L`
      <details class="points-rewards">
        <summary>
          <span>${St("rewards",this.config?.locale,this.hass)}</span>
          <p>${St("how_points_work",this.config?.locale,this.hass)}</p>
        </summary>
        <div class="rewards-content">
          ${i.size?L`
                <section>
                  <h2>${St("chores",this.config?.locale,this.hass)}</h2>
                  ${[...i.entries()].sort(([t],[e])=>e-t).map(([t,e])=>L`
                        <h3>${t} ${St("points",this.config?.locale,this.hass)}</h3>
          ...
          ${e.length?L`
                <section>
                  <h2>${St("reward_levels",this.config?.locale,this.hass)}</h2>
                  <ul class="reward-list">
                    ${e.map(t=>L`
                        <li><strong>${t.points}p:</strong> ${t.label}${t.description?L` - ${t.description}`:q}</li>
                      `)}
                  </ul>
                </section>
              `:q}
